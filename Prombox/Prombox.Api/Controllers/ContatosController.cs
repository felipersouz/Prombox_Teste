...
namespace Prombox.Web.Controllers
{
    ...
    public class ContatosController : BaseController
    {
        ...
        public ContatosController(IContatosService service, ICurrentUser currentUser)
        {
            _service = service;
        ...
        [HttpPost]
        public ActionResult Post([FromBody] ContatosCreateCommand command)
        {
            if (command == null)
                return BadRequest();
        ...
        [ProducesResponseType(400)]
        [HttpPut("{id}")]
        public ActionResult Put(int id, [FromBody] ContatosUpdateCommand command)
        {
            if (command == null)
                return BadRequest();
        ...
        public ActionResult Delete(int id)
        {
            ...
            var result = _service.Delete(new ContatosDeleteCommand { Id = id });
