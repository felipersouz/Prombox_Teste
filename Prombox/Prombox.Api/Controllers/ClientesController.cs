...
namespace Prombox.Web.Controllers
{
    ...
    public class ClientesController : BaseController
    {
        ...
        [HttpPost]
        public ActionResult Post([FromBody] ClienteCreateCommand command)
        {
            if (command == null)
                return BadRequest();
        ...
        [ProducesResponseType(400)]
        [HttpPut("{id}")]
        public ActionResult Put(long id, [FromBody] ClienteUpdateCommand command)
        {
            if (command == null)
                return BadRequest();
        ...
        public ActionResult Delete(long id)
        {
            ...
            var result = _service.Delete(new ClienteDeleteCommand { Id = id });
